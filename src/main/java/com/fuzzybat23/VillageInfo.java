...
public class VillageInfo
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        data.authorList.add("Chunkbase");
        data.url = "https://minecraft.curseforge.com/members/fuzzybat23/projects";
        data.credits = "Bats everywhere.  Chunkbase hadn't updated their mod since 1.11, so I rewrote it and updated it for 1.12";
    ...
    private void getVillageData(RenderGameOverlayEvent.Text event, EntityPlayer player)
    {
        ...
        //VillageCollection villageCollection = worldServer.getVillageCollection();
